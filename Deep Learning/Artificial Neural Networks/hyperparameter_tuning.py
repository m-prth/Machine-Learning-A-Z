...
c = [grid_result.best_score_, grid_result.best_params_]
print(c)
'''
2020-06-16 12: 14: 30.801906: I tensorflow/stream_executor/platform/default/dso_loader.cc: 44] 
Successfully opened dynamic library cublas64_10.dll
    [0.8570000052452087, {'activation': 'relu',
                          'batch_size': 128, 'epochs': 30, 'layers': (40, 20)}]
'''